    ...
    return (
        <html lang="pt-BR">
            <head>
                ...
                <noscript>
                    <img 
                        ...
                        width="1" 
                        style={{ display: "none" }}
                        src="https://www.facebook.com/tr?id=2487931431710589&ev=PageView&noscript=1"
                        alt=""
                    />
                </noscript>
                {/* End Meta Pixel Code */}
            ...
            <body className="antialiased grain-overlay">
                ...
                <noscript>
                    <iframe
                        src="https://www.googletagmanager.com/ns.html?id=GTM-W7KZ6TFK"
                        height="0"
                        width="0"
                ...
                <Script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: `
                            ...
                            })(window,document,'script','dataLayer','GTM-W7KZ6TFK');
                        `,
                    }}
                />
                <Script
