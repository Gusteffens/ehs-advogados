...
import type { AuthorOption } from "@/types/blog";
...
export default function NovoPostPage() {
    ...
    useEffect(() => {
        ...
        supabase
            ...
            .then(({ data }) => {
                if (data) {
                    const fetchedAuthors = data as AuthorOption[];
                    setAuthors(fetchedAuthors);
                    setAuthorId((currentAuthorId) => currentAuthorId || fetchedAuthors[0]?.id || "");
                }
            });
    }, []);
    ...
    const handleSave = (status: "draft" | "published") => {
        ...
        startTransition(async () => {
            try {
                ...
                console.error(error);
                alert("Erro ao salvar o post: " + getErrorMessage(error));
            }
        });
    };
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[#3B5A3C] text-xs mt-0.5">
                            Preencha os campos e escreva seu artigo
                        </p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="rounded-2xl bg-white border border-forest-100 p-5">
                        ...
                        />
                        <p className="text-[10px] text-[#3B5A3C]/70 mt-2">
                    ...
                    <div className="rounded-2xl bg-white border border-forest-100 p-5">
                        ...
                        />
                        <p className="text-[10px] text-[#3B5A3C]/70 mt-2">
                            Até 160 caracteres para melhor SEO
                        </p>
                    </div>
                    ...
                    <div className="rounded-2xl bg-[#1B2D1E] p-5">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-[#EEEDE5]/40 text-xs line-clamp-2">
                                {excerpt ||
                                    "O resumo do artigo será exibido aqui nos resultados de busca..."}
                            </p>
                        </div>
                    </div>
                </div>
